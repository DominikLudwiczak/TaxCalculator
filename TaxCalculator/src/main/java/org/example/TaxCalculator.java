...
public class TaxCalculator {
    ...
    private static double taxPaid;
    private static double soc_sick_secur;
    private static double advanceTax;
    private static double advanceTaxPaid;
    private static double soc_securitys;
    private static char umowacontractType;
